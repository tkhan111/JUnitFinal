...
public class CheckToddlePage {

	WebDriver driver;

	public CheckToddlePage(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void addCheckBoxes(int randomNum) {
		...
		System.out.println("this is x" + randomNum);
		for (int i = 0; i <= randomNum; i++) {
			TextBox.sendKeys("Abc" + i);
			AddButton.click();
		}
	}

	public void clickToddleAllToSelectAllCheckedBoxes()  {
